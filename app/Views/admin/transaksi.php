                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if ($t['status'] == 2) {
                                        ?>
                                            <div class="alert alert-success d-flex align-items-center w-1" role="alert" style="width: 9em;">
                                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:">
                                                    <use xlink:href="#check-circle-fill" />
                                                </svg>
                                                <div>
                                        ...
                                        ?>
                                            <div class="alert alert-warning d-flex align-items-center" role="alert" style="width: 9em;">
                                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Warning:">
                                                    <use xlink:href="#exclamation-triangle-fill" />
                                                </svg>
                                                <div>
                                        ...
                                        ?>
                                            <div class="alert alert-danger d-flex align-items-center" role="alert" style="width: 9em;">
                                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Warning:">
                                                    <use xlink:href="#exclamation-triangle-fill" />
                                                </svg>
                                                <div>
                                                            ...
                                                            <form action="/admin/updatepackage/<?= $t['notransaksi']; ?>" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><?= number_to_currency($harga, 'Rp.'); ?></td>
                                                                            </tr>
                                                                        <?php endforeach
                                                                        ?>
                                                                        <tr>
                                                                            <th></th>
                                                                            <th>Ongkos Kirim</th>
                                                                            <td><?= number_to_currency($t['ongkir'], 'Rp.'); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th></th>
                                                                            <th>Harga Total Bayar</th>
                                                                            <td><?= number_to_currency($t['total'], 'Rp.'); ?></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <?php if ($t['status'] == 3) {
                                                                ?>
                                                                    <div class="alert alert-danger" role="alert" style="text-align: center;">
                                                                        Pesanana Dibatalkan. Nilai Pembayaran tidak sesuai dengan harga total
                                                                    </div>
                                                                <?php
                                                                } ?>
                                                                ...
                                                                <div class="container" style="padding-right: 15em; padding-left: 15em; text-align: center;">
                                                                    <?php if ($t['pembayaran'] != null) {
                                                                    ?>
                                                                        <div class="card text-dark bg-light mb-3" style="max-width: 30rem; margin: auto;">
                                                                            <div class="card-header">Bukti Pembayaran</div>
                                                                            <div class="card-body">
                                                                                <img src="/assets/payment/<?= $t['pembayaran']; ?>" alt="bukti pembayaran" style="max-width: 25rem; max-height: 25rem;">
                                                                            </div>
                                                                        </div>
                                                                    <?php   } else {
                                                                    ?>
                                                                    ...
                                                                    ?>
                                                                    <input type="hidden" name="admin" value="<?= session()->get('username'); ?>">
                                                                    ...
                                                                    <button type="submit" class="btn btn-second my-3 " onclick="myFunction()">Batalkan</button>

                                                                    <script>
                                                                        function myFunction() {
                                                                            alert("Anda yakin mebatalkan pesanan??");
                                                                            window.location.href = "/admin/cancle/<?= $t['notransaksi']; ?>";
                                                                        }
                                                                    </script>
