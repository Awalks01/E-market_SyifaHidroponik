                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if ($t['status'] == 2) {
                                        ?>
                                            <div class="alert alert-success d-flex align-items-center w-1" role="alert" style="width: 7em;">
                                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:">
                                                    <use xlink:href="#check-circle-fill" />
                                                </svg>
                                                <div>
                                        ...
                                        ?>
                                            <div class="alert alert-warning d-flex align-items-center" role="alert" style="width: 7em;">
                                                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Warning:">
                                                    <use xlink:href="#exclamation-triangle-fill" />
                                                </svg>
                                                <div>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <section>
                                                            <form action="/cart/updatepayment/<?= $t['notransaksi']; ?>" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="container" style="padding-right: 15em; padding-left: 15em; text-align: center;">
                                                                    ...
                                                                    <input class="form-control" type="file" id="formFile" name="payment" required>
