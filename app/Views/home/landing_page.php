...
<!-- <section class="features-icons bg-light py-5">
    <div class="container">
        ...
        //foreach ($post as $p) :
        ?>
            <a href="/home/detailblog/<? //$p['judul']; 
                                        ?>" style=" text-decoration:none; color : black;">
                <div class="card mb-3">
                    <div class="row g-0 h-1">
                        <div class="col-md-2">
                            <img src="/assets/uploadimg/<? //$p['gambar'] 
                                                        ?>" class="img-fluid rounded-start" alt="..." style="width:200px;height:200px;">
                        </div>
